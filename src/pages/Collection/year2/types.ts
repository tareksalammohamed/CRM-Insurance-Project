...
export type Year2EligiblePolicy = Policy & {
  ...
  // إجمالي عدد مرات التحصيل الفعلية للوثيقة من أول بداية التأمين (أقساط
  // السنة الأولى المسددة من installments + تحصيلات السنة الثانية وما بعدها
  // غير الملغاة من year2_payments) — رقم واحد شامل محسوب فى خدمة الجلب،
  // مش عمود فى قاعدة البيانات ولا يُستخدم فى أي حساب غير العرض
  total_paid_installments_count?: number;
  // رقم السنة التأمينية الحالية للوثيقة (٢ = سنة ثانية، ٣ = سنة ثالثة...)
  // محسوب من تاريخ البداية مقابل تاريخ اليوم — مش عمود فى قاعدة البيانات
  policy_year_number?: number;
